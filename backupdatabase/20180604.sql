...
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='phan quyen chuc nang';
...
INSERT INTO `chucnang` VALUES (1,'mnuQuanLyHangHoa','menu','Quản lý nhóm hàng hóa'),(2,'mnuQuanLyNhaCungCap','menu','Quản lý nhà cung cấp'),(3,'mnuQuanLyKhachHang','menu','Quản lý khách hang'),(4,'mnuQLHangHoa','menu','Quản lý hàng hóa'),(5,'mnuDangKy','menu','Đăng ký tài khoản');
...
INSERT INTO `dangnhap` VALUES ('hoa','12345'),('huong','12345');
...
INSERT INTO `nhanvien` VALUES ('KD000001','Tạ Thị Hòa','KD','Phú Thọ','01649164396','tathihoa2@gmail.com');
...
CREATE TABLE `nhomuserchucnang` (
  ...
  UNIQUE KEY `machucnang_UNIQUE` (`machucnang`),
  UNIQUE KEY `manhomuser_UNIQUE` (`manhomuser`),
...
-- Dump completed on 2018-06-04  2:10:50
